    ...
    <div class="row gutters-10">
        ...
        @if (get_setting('cash_payment') == 1)
            ...
            @if ($digital != 1 && $cod_on == 1)
                ...
                <div class="col-xl-4 col-md-6">
                    <label class="aiz-megabox d-block mb-3">
                        <input value="eps_payment" class="online_payment" type="radio"
                            name="payment_option" checked>
                        <span class="d-flex align-items-center justify-content-between aiz-megabox-elem rounded-0 p-3">
                            <span class="d-block fw-400 fs-14">{{ translate('EPS Payment') }}</span>
                            <span class="rounded-1 h-40px w-90px overflow-hidden">
                                <img src="{{ static_asset('assets/img/cards/eps_logo.png') }}"
                                class="img-fit h-100">
                            </span>
                        </span>
                    </label>
